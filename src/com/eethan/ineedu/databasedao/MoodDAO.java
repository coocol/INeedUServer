...
public class MoodDAO extends DAO<Mood>{
	public static String TABLE_NAME = "mood";
	private static Class myClass = Mood.class;
	...
	public List<Mood> getNearMood(double myLng,double myLat,String sex,double distance,int start,int maxNum,boolean getMore){
		try {
		    ...
		    while (rs.next()) {
		    	...
		    	{
		    		field = Mood.class.getDeclaredField(key);
