...
public class WishWithWannaNum {
	...
	public void setPickerNum(int pickerNum) {
		this.pickerNum = pickerNum;
	}
	public WishWithWannaNum(int id,int userId,String content,int auth,String time,
			double lng,double lat,int flowerNum,int commentNum,int pickerNum,
